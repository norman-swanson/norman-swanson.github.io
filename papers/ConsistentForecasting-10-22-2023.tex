...
%TCIDATA{LastRevised=Sunday, October 22, 2023 11:27:27}
...
we draw on results of Chao, Liu, and Swanson (CLS: 2023a), where a
...
impetus for the work of Chao, Liu, and Swanson (CLS: 2023a), where a
...
be used in factor estimation. CLS (2023a) show that for their procedure, the
...
estimated using predictor variables selected using the procedure of CLS
...
model, the variable selection procedure of CLS (2023a), and the assumptions
...
\noindent \qquad Following CLS (2023a), we begin by considering the
...
Following Chao, Liu, and Swanson (2023a), we assume that not all components
...
Johnstone and Paul (2018).} As discussed in CLS (2023a), there is an
...
discussion of this Assumption, see CLS (2023a).
...
outlined in CLS (2023a), and draws on pathbreaking moderate deviation
...
standard normal as the threshold function, refer to CLS (2023a), and note
...
refer to CLS (2023a). Given the above assumptions, Theorem 1 of CLS (2023a)
...
CLS (2023a) also note that the above variable selection procedure provides
...
results reported in Section 3 of CLS (2023a) show that the variable
...
statistic (see Chao, Liu, and Swanson (CLS: 2023a) that correctly identifies
...
Furthermore, CLS(2023a) show that estimating the factors using only those
...
respectively, to Lemmas OA-1, OA-2, OA-3, OA-5, and OA-11 in Chao, Liu, and
...
Liu, and Swanson (2023b) for the vector moving-average representation of $%
W_{t}$, i.e., 
\begin{equation*}
...
\end{equation}%
and note first that, setting $\delta =5$ in Lemma OA-8 of Chao, Liu, and
...
}{{\large 6}}}\right] ^{-2}\text{ }\left( \text{by Lemma OA-10 of Chao, Liu,
and Swanson (2023b)}\right) \\
&<&\infty \text{ \ }\left( \text{since }0<\phi _{\max }^{\frac{{\large 5}}{%
{\large 6}}}<1\text{ given that }0<\phi _{\max }<1\right) \text{.}
\end{eqnarray*}

Hence, all conditions of Lemma OA-8 of Chao, Liu, and Swanson (2023b) are
...
in the proof of part (a) of Theorem 1 (see Chao, Liu, and Swanson (2023b)),
...
\right\} ^{c}
\end{eqnarray*}%
Hence, applying either part (a) or part (b) of Theorem 2 in Chao, Liu, and
...
,T}\right\vert $, we can apply the results of Theorem 2 in Chao, Liu, and
...
Theorem 1 in }\right. \\
&&\left. \text{Chao, Liu, and Swanson (2023a)\footnote{%
...
by Theorem 2 in Chao, Liu, and Swanson (2023a)}\right)
\end{eqnarray*}%
from which we further deduce that%
\begin{equation*}
\left\Vert \frac{\Gamma \left( \widehat{H^{c}}\right) -\Gamma }{\sqrt{N_{1}}}%
...
&\rightarrow &0\text{ ,}
\end{eqnarray*}%
since, by Theorem 2 in Chao, Liu, and Swanson (2023a), $P\left( \min_{i\in
...
the proof of Theorem 1 in Chao, Liu, and Swanson (2023b),%
\begin{eqnarray*}
...
where $\mathbb{S}_{i,T}^{+}=\max_{1\leq \ell \leq d}\left\vert S_{i,\ell
,T}\right\vert $, we have, by applying an argument similar to that given in
the proof of Theorem 1 as shown in Chao, Liu, and Swanson (2023b),%
\begin{eqnarray*}
&&\Pr \left\{ \frac{1}{N_{1}}\dsum\limits_{i\in H}\mathbb{I}\left\{ i\in 
...
=1}^{d}\varpi _{\ell }\left\vert S_{i,\ell ,T}\right\vert $ or the case
where $\mathbb{S}_{i,T}^{+}=\max_{1\leq \ell \leq d}\left\vert S_{i,\ell
,T}\right\vert $, we have, by applying Theorem 2 in Chao, Liu, and Swanson
(2023a),%
\begin{eqnarray*}
0 &\leq &E\left[ \frac{1}{N_{1}}\dsum\limits_{i\in H^{{\large c}}}\left( 1-%
\mathbb{I}\left\{ i\in \widehat{H^{c}}\right\} \right) \right] \\
...
&&\left( \text{following an argument similar to that given in the proof of
Theorem 1 }\right. \\
&&\left. \text{as shown in Chao, Liu, and Swanson (2023b)}\right) \\
&\rightarrow &0\text{ as }N_{1},N_{2},T\rightarrow \infty
\end{eqnarray*}%
Moreover, making use of part (b) of Assumption 3-3, we have%
\begin{eqnarray*}
...
Selecting the Relevant Variables for Factor Estimation in FAVAR
Models,\textquotedblright\ Working Paper, Rutgers University and University
of Maryland.

\bibitem{} Chao, J.C., Y. Liu, and N. R. Swanson (2023b): \textquotedblleft
Online Appendix to Selecting the Relevant Variables for Factor Estimation in
FAVAR\ Models," Working Paper, Rutgers University and University of Maryland.
