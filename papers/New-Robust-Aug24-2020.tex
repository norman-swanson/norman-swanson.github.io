...
%TCIDATA{LastRevised=Monday, August 24, 2020 11:30:12}
...
\right] _{+}-\frac{1}{n}\sum_{t=1}^{n}1\left[ e_{1,t}-x\right] _{+}$ and $%
u_{j,t}^{\ast }(x)$ with $\eta _{j,t}^{\ast }(x)=\left[ e_{j,t}^{\ast }-x%
\right] _{+}-\frac{1}{n}\sum_{t=1}^{n}1\left[ e_{j,t}-x\right] _{+}.$
Additionally, define
...
\frac{1}{n}\sum_{t=1}^{n}\left[ (e_{1,t}-x)sgn(x)\right] _{+},$\ replace $%
\eta _{j,t}^{\ast }(x)$\ with $\eta _{j,t}^{\ast }(x)=\left[ (e_{j,t}^{\ast
}-x)sgn(x)\right] _{+}-\frac{1}{n}\sum_{t=1}^{n}\left[ (e_{j,t}-x)sgn(x)%
\right] _{+},$\ and define
...
'QFKOXE02.wmf';tempfile-properties "XPR";}}
...
"1";cropbottom "0";tempfilename 'QFKOXE03.wmf';tempfile-properties "XPR";}}
\end{center}
