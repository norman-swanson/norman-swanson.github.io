...
%TCIDATA{LastRevised=Saturday, September 26, 2020 10:56:28}
...
\begin{table}[tbp]
\caption{Supplemental S1 -- Monte Carlo Results for $JCS_n^{G+}$, $%
JCS_n^{G-} $, $JCS_n^{C+}$, and $JCS_n^{C-}$ Forecast Superiority Tests$^*$}{%
\centering}
\par
\hspace{1cm}
\par
